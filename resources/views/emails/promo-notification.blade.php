...
<body style="margin: 0; padding: 0; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; background-color: #0a0a0a;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #0a0a0a; padding: 40px 20px;">
        <tr>
            <td align="center">
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background-color: #1a1a1a; border-radius: 16px; overflow: hidden; border: 1px solid #333;">
                    <!-- Header -->
                    <tr>
                        ...
                        <td style="padding: 40px 30px;">
                            @if($promoType === 'banner')
                                ...
                                @if(isset($promoData['image_url']))
                                    <img src="{{ $promoData['image_url'] }}" alt="Promo Banner" style="width: 100%; border-radius: 12px; margin-bottom: 20px;">
                                @endif
                                
                                <h2 style="color: #ffffff; font-size: 24px; margin: 0 0 15px; font-weight: bold;">
                            ...
                            @elseif($promoType === 'voucher')
                                ...
                                <div style="text-align: center; margin-bottom: 25px;">
                                    <p style="color: #a0a0a0; margin: 0 0 10px; font-size: 14px;">Gunakan Kode Voucher:</p>
                                    <div style="background: linear-gradient(135deg, #35c759 0%, #2a9d47 100%); display: inline-block; padding: 15px 30px; border-radius: 8px;">
                                ...
                                <div style="background-color: #252525; border-radius: 12px; padding: 20px; text-align: center;">
                                    ...
                                    @if(isset($promoData['min_purchase']) && $promoData['min_purchase'] > 0)
                                        <p style="color: #a0a0a0; font-size: 14px; margin: 10px 0 0;">
                            ...
                            <div style="text-align: center; margin-top: 30px;">
                                <a href="{{ config('app.url') }}/menu" style="display: inline-block; background: linear-gradient(135deg, #35c759 0%, #2a9d47 100%); color: #ffffff; text-decoration: none; padding: 15px 40px; border-radius: 50px; font-weight: bold; font-size: 16px;">
                                    Pesan Sekarang →
                                </a>
                            </div>
                        </td>
                    ...
                    <!-- Footer -->
                    <tr>
                        <td style="background-color: #0f0f0f; padding: 25px; text-align: center; border-top: 1px solid #333;">
